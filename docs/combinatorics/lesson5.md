...
## 1. Integer partitions and Gaussian coefficients
...
## 2. Conjugation and unrestricted partition generating functions
...
## 4. Self-conjugate partitions and odd diagonal hooks
...
## 5. Euler's odd-distinct partition theorem
...
## 6. Three bivariate partition identities
